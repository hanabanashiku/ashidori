...
describe('Extension helpers', () => {
    ...
    describe('send notification', () => {
        ...
        function getButtonListener() {
            if (
                !browser.notifications.onButtonClicked.addListener.mock.calls
                    .length
            ) {
                return null
            }
            return browser.notifications.onButtonClicked.addListener.mock
                .calls[0][0]
        }

        function getClickListener() {
            if (
                !browser.notifications.onClicked.addListener.mock.calls.length
            ) {
                return null
            }
    ...
    describe('executeScript', () => {
        ...
        it('executes scripts for manifest v2', async () => {
            ...
            expect(browser.tabs.executeScript).toHaveBeenCalledTimes(
                scripts.length
            )
